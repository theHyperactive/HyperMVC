<body>
	<div class="container">
		<div class="content">
			<h2>Welcome!</h2>
			<p class="text">This is a small codeiginter like "framework" following MVC programing paradigm. It's primary purpose is to help setting up small staging examples that we use in creating prototypes of web applications and/or dynamic websites.</p>
